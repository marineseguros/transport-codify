...
const Funil = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'Em cotação': return 'border-l-blue-500 bg-blue-50';
      case 'Negócio fechado': return 'border-l-green-500 bg-green-50';
      case 'Declinado': return 'border-l-red-500 bg-red-50';
