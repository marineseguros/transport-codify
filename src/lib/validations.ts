...
export const csvRowSchema = z.object({
  segurado: z.string().trim().min(1, { message: 'Segurado é obrigatório' }),
  cpf_cnpj: z.string().trim().min(1, { message: 'CPF/CNPJ é obrigatório' }),
  // Add other required CSV fields as needed
});
